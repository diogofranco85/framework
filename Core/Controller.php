...
class Controller{
    ...
    {
        if(!$external){
            $uri = $this->htmldata['url_base'].'/'.$uri;
        }
    ...
    public function toJson(array $json)
    {
    ...
    {
        return key_exists($key, $this->htmldata) ? $this->htmldata[$key] : false;
    }
    ...
    {
        $html = $this->view->render($file, $this->htmldata);
    ...
    {
        return $this->view->render($file, $this->htmldata);
    }
